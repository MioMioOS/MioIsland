...
private let logger = Logger(subsystem: "com.codeisland", category: "Interrupt")
...
class JSONLInterruptWatcher {
    ...
    private let queue = DispatchQueue(label: "com.codeisland.interruptwatcher", qos: .userInteractive)
