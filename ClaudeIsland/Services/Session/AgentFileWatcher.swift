...
private let logger = Logger(subsystem: "com.codeisland", category: "AgentFileWatcher")
...
class AgentFileWatcher {
    ...
    private let queue = DispatchQueue(label: "com.codeisland.agentfilewatcher", qos: .userInitiated)
